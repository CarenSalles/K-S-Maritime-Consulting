...
public class ServiceControllerTest<ServiceModel> {
    ...
    public void testRetrieveAllServices() throws Exception {
        ...
        MockHttpServletResponse response = this.mockMvc.perform(MockMvcRequestBuilders.get("/api/services"))
        ...
        assertEquals(response.getContentAsString(null), mapper.writeValueAsString(services));
